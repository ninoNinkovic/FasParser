...
2. With the provided ID list, you can also rename the sequence IDs (Figure 5). To achieve that, the ID list should have two columns, the first column refers to the raw ID, and the second column refers to the new ID, as below:
